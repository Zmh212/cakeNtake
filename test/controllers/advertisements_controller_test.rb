...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post advertisements_url, params: { advertisement: { description: @advertisement.description, enddate: @advertisement.enddate, imagepath: @advertisement.imagepath, startdate: @advertisement.startdate, title: @advertisement.title } }
    end
  ...
  test "should update advertisement" do
    patch advertisement_url(@advertisement), params: { advertisement: { description: @advertisement.description, enddate: @advertisement.enddate, imagepath: @advertisement.imagepath, startdate: @advertisement.startdate, title: @advertisement.title } }
