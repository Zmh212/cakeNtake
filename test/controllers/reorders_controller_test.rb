...
class ReordersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reorder" do
    assert_difference('Reorder.count') do
      post reorders_url, params: { reorder: { expecteddelivery: @reorder.expecteddelivery, product_id: @reorder.product_id, qtyorder: @reorder.qtyorder, reorderdate: @reorder.reorderdate } }
    end
  ...
  test "should update reorder" do
    patch reorder_url(@reorder), params: { reorder: { expecteddelivery: @reorder.expecteddelivery, product_id: @reorder.product_id, qtyorder: @reorder.qtyorder, reorderdate: @reorder.reorderdate } }
